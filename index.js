    ...
    if (food.length !== 0) {
      ...
      for (var i = 0; i < food.length; i++) {
        let cartTxt =
          ...
          food[i][3] +
          '<p></div><i class="fas fa-peso-sign"> ' +
          food[i][2] +
          '</i></p>  </div>  <div class="col-2"> <p class="text-muted-small" > <i class="fas fa-peso-sign"></i> ' +
          food[i][1] * food[i][2] +
...
function openWhatsapp() {
  ...
  if ($("#address")[0].value === "") {
    ...
    window.open("https://www.paypal.com/myaccount/transfer/homepage/send/09163923425S" + wTxtEncoded);
  }
}
